...
#SBATCH --output=/deep/u/ayushsn/satellite-pixel-synthesis-pytorch/logs/train_naip_256_3dec22_centercrop_d_2_lr_0.004.log
...
OUTPUT_DIR="5dec22_centercrop_lr_0.004_d_$CAPACITY_MULTIPLIER"
...
#torchrun --standalone --nnodes=1 --nproc_per_node=2 train_3dis.py --num_workers 16 --path $TRAIN_CSV --test_path $TEST_CSV --output_dir $OUTPUT_DIR --out_path $OUTPUT_PATH --iter 600000 --lr 0.004
