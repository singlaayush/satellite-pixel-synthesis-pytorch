...
torchrun --standalone --nnodes=1 --nproc_per_node=2 train_3dis.py --num_workers 16 --path $TRAIN_CSV --test_path $TEST_CSV --output_dir $OUTPUT_DIR --out_path $OUTPUT_PATH --iter 600000
